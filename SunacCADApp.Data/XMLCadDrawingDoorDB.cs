...
namespace SunacCADApp.Data
{
    public  class XMLCadDrawingDoorDB
    {
        ...
        protected static IList<Door> GetCadDrawingDoorsByWidth(double width, double doorType) 
        {
            IList<Door> listDoor = new List<Door>();
            string _where = "1=1";
            _where+=width>0?string.Format(@" AND (b.WindowSizeMin>='{0}' AND b.WindowSizeMax<='{1}')  ",width):string.Empty;
            _where += doorType > 0 ? string.Format(@" AND b.DoorType='{0}'", doorType) : string.Empty; 
            string sql = string.Format(@" SELECT  a.Id,a.DrawingCode,a.DrawingName,a.Scope,a.DynamicType,
                                                                      ...
                                                                      b.DoorType,c.ArgumentText AS DoorTypeName,b.WindowSizeMin,b.WindowSizeMax
        ...
        public static IList<Door> GetCadDrawingDoorsListByWidth(double width, double doorType) 
        {
